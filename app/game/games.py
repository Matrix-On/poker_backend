...
from ..schemas.games import ActiveGamesResponceSchema, ActiveGamesSchema, GameInfoResponceSchema, StatusSchema, GameOperationRequestSchema, HeroRequestSchema, NewGameRequestSchema, NewGameResponceSchema
...
async def get_active_games() -> ActiveGamesResponceSchema:
    ...
    data: List[ActiveGamesSchema] = [
        ActiveGamesSchema(id=1, name="nm1", started_at=None, price_rebuy=10, chip_count=1000, level_minutes=15, break_minutes=15),
        ...
        ActiveGamesSchema(id=4, name="nm4", started_at=None, price_rebuy=40, chip_count=4000, level_minutes=45, break_minutes=45),
